  ...
  <body style="background-color: #e3f2f1">
      ...
      <div class="container card-lapang" style="margin-top: 100px">
        ...
        >
          <div class="card-body">
            ...
            <button
              type="button"
              class="btn btn-primary btn-danger mt-2"
              data-toggle="modal"
              data-target="#myModal"
              style="background-color: #9a2929; color: white"
            >
              Selesai
            </button>
          </div>
    ...
    >
      <div class="modal-dialog">
        <div
          class="modal-content"
          style="background-color: #9a2929; border-radius: 20px"
        >
          <div class="modal-body text-center" style="color: white">
            ...
            />
            <h3>Pembayaran anda telah berhasil</h3>
            <p style="color: #d4d4d4">
              Terimakasih telah menggunakan layanan kami
            </p>
          </div>
          <div
            class="modal-body text-Center border-top"
